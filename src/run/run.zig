...
pub fn run(init: std.process.Init, args: []const []const u8) !void {
    ...
    const wat = try build_run.compile_program_wat(io, allocator, parsed_cli.input_path, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, null, &loaded, null);
