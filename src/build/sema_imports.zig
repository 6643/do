...
fn descriptor_is_async_invocation(descriptor: p3_async_manifest.Descriptor) bool {
    ...
    return std.mem.eql(u8, descriptor.effect, "record-resource-list-stream-producer") or
        ...
        std.mem.eql(u8, descriptor.effect, "record-resource-two-list-owned-record-stream-producer") or
...
fn p3_async_signature_matches(tokens: []const lexer.Token, start_idx: usize, end_idx: usize, descriptor: p3_async_manifest.Descriptor) bool {
    ...
    if (shape) |resolved_shape| {
        switch (resolved_shape) {
            ...
            .record_resource_two_list_owned_record_stream_producer => return two_list_owned_record_stream_producer_signature_matches(tokens, close_idx, end_idx, descriptor),
...
fn two_list_owned_record_stream_producer_signature_matches(
    tokens: []const lexer.Token,
    params_close_idx: usize,
    end_idx: usize,
    descriptor: p3_async_manifest.Descriptor,
...
test "two-list owned-record producer host_async_func imports accept the exact record writer signature" {
    const source =
