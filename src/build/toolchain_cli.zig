...
fn usage(io: std.Io, code: u8) !void {
    ...
    try out.interface.writeAll("usage: do-toolchain probe | parse-core <input> -o <output> | strip-core <input> -o <output> | validate-core <wasm> | compile-core-gc <input> -o <output> | invoke-core-gc <module> --export <name> | run-core-gc <module> | embed-component <wit> <core> <world> [--features <none|component-async|core-gc-async>] -o <output> | embed-component-template <wit> <world> [--features <none|component-async|core-gc-async>] | new-component <embedded> -o <output> | validate-component <component> [--features <none|component-async|core-gc-async>] | component-wit <component> [--world <world>] | component-targets <wit> <component> --world <world> | print-component <component> | run-wasmtime <component> [-- <args...>]\n");
    try out.interface.flush();
