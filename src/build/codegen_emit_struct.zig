...
pub const emit_release_managed_locals = codegen_ownership.emit_release_managed_locals;
pub const emit_release_managed_locals_except = codegen_ownership.emit_release_managed_locals_except;
pub const emit_release_managed_locals_except_many = codegen_ownership.emit_release_managed_locals_except_many;
pub const emit_fallthrough_release_managed_locals = codegen_ownership.emit_fallthrough_release_managed_locals;
pub const emit_block_release_managed_locals = codegen_ownership.emit_block_release_managed_locals;
pub const has_managed_locals = codegen_ownership.has_managed_locals;
pub const managed_local_kind_for_type = codegen_ownership.managed_local_kind_for_type;
pub const collect_managed_ownership_locals = codegen_ownership.collect_managed_ownership_locals;
pub const build_return_ownership_plan = codegen_ownership.build_return_ownership_plan;
pub const build_guard_return_ownership_plan = codegen_ownership.build_guard_return_ownership_plan;
pub const build_fallthrough_ownership_plan = codegen_ownership.build_fallthrough_ownership_plan;
pub const build_block_ownership_plan = codegen_ownership.build_block_ownership_plan;
pub const emit_ownership_release_plan = codegen_ownership.emit_ownership_release_plan;
pub const body_ends_with_plain_return = codegen_control_flow.body_ends_with_plain_return;
pub const body_can_reach_end = codegen_control_flow.body_can_reach_end;
pub const stmt_can_reach_end = codegen_control_flow.stmt_can_reach_end;
pub const if_stmt_can_reach_end = codegen_control_flow.if_stmt_can_reach_end;
pub const loop_stmt_can_reach_end = codegen_control_flow.loop_stmt_can_reach_end;
