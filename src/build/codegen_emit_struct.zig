...
pub const emit_release_managed_locals = codegen_ownership.emitReleaseManagedLocals;
pub const emit_release_managed_locals_except = codegen_ownership.emitReleaseManagedLocalsExcept;
pub const emit_release_managed_locals_except_many = codegen_ownership.emitReleaseManagedLocalsExceptMany;
pub const emit_fallthrough_release_managed_locals = codegen_ownership.emitFallthroughReleaseManagedLocals;
pub const emit_block_release_managed_locals = codegen_ownership.emitBlockReleaseManagedLocals;
pub const has_managed_locals = codegen_ownership.hasManagedLocals;
pub const managed_local_kind_for_type = codegen_ownership.managedLocalKindForType;
pub const collect_managed_ownership_locals = codegen_ownership.collectManagedOwnershipLocals;
pub const build_return_ownership_plan = codegen_ownership.buildReturnOwnershipPlan;
pub const build_guard_return_ownership_plan = codegen_ownership.buildGuardReturnOwnershipPlan;
pub const build_fallthrough_ownership_plan = codegen_ownership.buildFallthroughOwnershipPlan;
pub const build_block_ownership_plan = codegen_ownership.buildBlockOwnershipPlan;
pub const emit_ownership_release_plan = codegen_ownership.emitOwnershipReleasePlan;
pub const body_ends_with_plain_return = codegen_ownership.bodyEndsWithPlainReturn;
pub const body_can_reach_end = codegen_ownership.bodyCanReachEnd;
pub const stmt_can_reach_end = codegen_ownership.stmtCanReachEnd;
pub const if_stmt_can_reach_end = codegen_ownership.ifStmtCanReachEnd;
pub const loop_stmt_can_reach_end = codegen_ownership.loopStmtCanReachEnd;
