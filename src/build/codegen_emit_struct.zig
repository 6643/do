...
const infer_storage_content_comparison_type = codegen_emit_storage_values.inferStorageContentComparisonType;
const storage_content_arg_compatible = codegen_emit_storage_values.storageContentArgCompatible;
const is_managed_payload_comparable_type = codegen_emit_storage_values.isManagedPayloadComparableType;
...
const storage_binding_elem_type = codegen_emit_storage_values.storageBindingElemType;
const managed_payload_binding = codegen_emit_storage_values.managedPayloadBinding;
const parse_storage_type = codegen_emit_storage_values.parseStorageType;
const emit_storage_bounds_check = codegen_emit_storage_values.emitStorageBoundsCheck;
const emit_storage_write_expr = codegen_emit_storage_values.emitStorageWriteExpr;
const emit_storage_set_expr = codegen_emit_storage_values.emitStorageSetExpr;
const emit_storage_put_call = codegen_emit_storage_values.emitStoragePutCall;
const emit_storage_put_expr = codegen_emit_storage_values.emitStoragePutExpr;
const emit_storage_put_spread_call = codegen_emit_storage_values.emitStoragePutSpreadCall;
const emit_storage_set_scalar_call = codegen_emit_storage_values.emitStorageSetScalarCall;
const emit_storage_put_spread_scalar_element = codegen_emit_storage_values.emitStoragePutSpreadScalarElement;
const emit_storage_put_scalar_call = codegen_emit_storage_values.emitStoragePutScalarCall;
const emit_storage_clone_current_len = codegen_emit_storage_values.emitStorageCloneCurrentLen;
const emit_storage_clone_current_len_for_elem = codegen_emit_storage_values.emitStorageCloneCurrentLenForElem;
const emit_storage_clone_managed_current_len = codegen_emit_storage_values.emitStorageCloneManagedCurrentLen;
const emit_storage_clone_managed_with_len_local = codegen_emit_storage_values.emitStorageCloneManagedWithLenLocal;
const emit_storage_inc_copied_managed_elements = codegen_emit_storage_values.emitStorageIncCopiedManagedElements;
const emit_storage_clone_with_len_local = codegen_emit_storage_values.emitStorageCloneWithLenLocal;
const emit_storage_clone_with_len_local_for_elem = codegen_emit_storage_values.emitStorageCloneWithLenLocalForElem;
const emit_storage_clone_with_len_local_typed = codegen_emit_storage_values.emitStorageCloneWithLenLocalTyped;
const emit_storage_inc_copied_pack_elements = codegen_emit_storage_values.emit_storage_inc_copied_pack_elements;
const emit_storage_element_ptr_from_local = codegen_emit_storage_values.emitStorageElementPtrFromLocal;
const emit_storage_element_ptr_from_local_with_indent = codegen_emit_storage_values.emitStorageElementPtrFromLocalWithIndent;
const emit_storage_alias_protect = codegen_emit_storage_values.emitStorageAliasProtect;
const emit_storage_alias_release = codegen_emit_storage_values.emitStorageAliasRelease;
...
const storage_element_byte_width_for_type = codegen_emit_storage_values.storageElementByteWidthForType;
...
const storage_pack_layout_for_elem = codegen_emit_storage_values.storagePackLayoutForElem;
const tuple_element_pack_offset_with_structs = codegen_emit_storage_values.tuple_element_pack_offset_with_structs;
const tuple_field_path_type = codegen_emit_storage_values.tupleFieldPathType;
...
const emit_replace_storage_put_source_tmp = codegen_emit_storage_values.emitReplaceStoragePutSourceTmp;
const direct_managed_local_expr_name = codegen_emit_storage_values.directManagedLocalExprName;
const emit_overwrite_release_managed_local = codegen_emit_storage_values.emitOverwriteReleaseManagedLocal;
...
const find_struct_field_type = codegen_emit_storage_values.findStructFieldType;
...
const emit_storage_set_call = codegen_emit_storage_values.emitStorageSetCall;
const emit_storage_put_one_call = codegen_emit_storage_values.emitStoragePutOneCall;
...
const emit_storage_set_managed_call = codegen_emit_storage_values.emitStorageSetManagedCall;
const emit_storage_put_managed_call = codegen_emit_storage_values.emitStoragePutManagedCall;
...
const infer_set_call_type = codegen_emit_storage_values.inferSetCallType;
...
const infer_put_call_type = codegen_emit_storage_values.inferPutCallType;
...
const infer_field_get_call_type = codegen_emit_storage_values.inferFieldGetCallType;
const func_variadic_elem_type = codegen_storage_layout.func_variadic_elem_type;
const infer_field_set_call_type = codegen_emit_storage_values.inferFieldSetCallType;
...
const infer_get_call_type = codegen_emit_storage_values.inferGetCallType;
...
const infer_tuple_field_path_get_type = codegen_emit_storage_values.inferTupleFieldPathGetType;
...
const union_local_default_payload_type = codegen_emit_storage_values.unionLocalDefaultPayloadType;
const union_local_default_struct_payload = codegen_emit_storage_values.unionLocalDefaultStructPayload;
const find_narrowed_union_type = codegen_emit_storage_values.findNarrowedUnionType;
...
const lambda_param_type_name = codegen_emit_storage_values.lambdaParamTypeName;
const lambda_explicit_return_type = codegen_emit_storage_values.lambdaExplicitReturnType;
...
const infer_lambda_expr_return_type = codegen_emit_storage_values.inferLambdaExprReturnType;
...
const managed_payload_elem_type_from_name = codegen_emit_storage_values.managedPayloadElemTypeFromName;
