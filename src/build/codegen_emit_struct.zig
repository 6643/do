...
pub const body_ends_with_plain_return = codegen_ownership.body_ends_with_plain_return;
pub const body_can_reach_end = codegen_ownership.body_can_reach_end;
pub const stmt_can_reach_end = codegen_ownership.stmt_can_reach_end;
pub const if_stmt_can_reach_end = codegen_ownership.if_stmt_can_reach_end;
pub const loop_stmt_can_reach_end = codegen_ownership.loop_stmt_can_reach_end;
