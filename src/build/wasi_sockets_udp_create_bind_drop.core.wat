(module
  ...
  (import "wasi:sockets/types@0.3.0" "[static]udp-socket.create" (func $udp-create (type $create)))
  (import "wasi:sockets/types@0.3.0" "[method]udp-socket.bind" (func $udp-bind (type $bind)))
  (import "wasi:sockets/types@0.3.0" "[resource-drop]udp-socket" (func $udp-drop (type $drop)))
