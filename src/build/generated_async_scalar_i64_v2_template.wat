(module
  ...
  (import "__V2_ASYNC_IMPORT_MODULE__" "__V2_ASYNC_COMPLETION__"
    (func $completion (type $completion)))
  (import "__V2_ASYNC_IMPORT_MODULE__" "__V2_ASYNC_IMPORT_NAME__"
    (func $future-read (type $future-read)))
  (import "__V2_ASYNC_IMPORT_MODULE__" "[async-lower][future-cancel-read-0]__V2_ASYNC_COMPLETION__"
    (func $future-cancel-read (type $future-cancel-read)))
  (import "__V2_ASYNC_IMPORT_MODULE__" "[future-drop-readable-0]__V2_ASYNC_COMPLETION__"
  ...
  ;; Frame: waitable-set @0, future reader @4, state @8, scalar payload @__V2_PAYLOAD_OFFSET__.
  ;; [scalar-payload] offset=__V2_PAYLOAD_OFFSET__ byte-size=__V2_PAYLOAD_BYTE_SIZE__ alignment=__V2_PAYLOAD_ALIGNMENT__ encoding=__V2_PAYLOAD_ENCODING__
  ...
  (func $start-second (param $frame i32) (result i32) (local $future i32) (local $code i32)
    ...
    local.get $future
    local.get $frame
    i32.const __V2_PAYLOAD_OFFSET__
    i32.add
    call $future-read
    local.tee $code
    i32.const -1
