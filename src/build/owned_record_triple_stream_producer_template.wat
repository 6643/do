(module
  ...
  (type $async-run-triple (func (param i32 i32 i32 i32) (result i32)))
  (type $async-callback (func (param i32 i32 i32) (result i32)))
  (type $task-return (func (param i32 i32)))
  (type $initialize (func))

  (import "do:g6-2-owned-record-triple-producer/types@0.1.0" "[resource-drop]ticket"
    (func $ticket-drop (type $resource-drop)))
  (import "do:g6-2-owned-record-triple-producer/source@0.1.0" "make-ticket"
    (func $make-ticket (type $make-ticket)))
  (import "do:g6-2-owned-record-triple-producer/sink@0.1.0" "[async-lower]consume-via-stream"
    (func $sink-call (type $async-lower)))
  (import "do:g6-2-owned-record-triple-producer/sink@0.1.0" "[stream-new-0]consume-via-stream"
    (func $stream-new (type $stream-new)))
  (import "do:g6-2-owned-record-triple-producer/sink@0.1.0" "[stream-cancel-read-0]consume-via-stream"
    (func $stream-cancel-read (type $stream-cancel)))
  (import "do:g6-2-owned-record-triple-producer/sink@0.1.0" "[stream-cancel-write-0]consume-via-stream"
    (func $stream-cancel-write (type $stream-cancel)))
  (import "do:g6-2-owned-record-triple-producer/sink@0.1.0" "[stream-drop-readable-0]consume-via-stream"
    (func $stream-drop-readable (type $stream-drop)))
  (import "do:g6-2-owned-record-triple-producer/sink@0.1.0" "[stream-drop-writable-0]consume-via-stream"
    (func $stream-drop-writable (type $stream-drop)))
  (import "do:g6-2-owned-record-triple-producer/sink@0.1.0" "[async-lower][stream-read-0]consume-via-stream"
    (func $stream-read (type $stream-io)))
  (import "do:g6-2-owned-record-triple-producer/sink@0.1.0" "[async-lower][stream-write-0]consume-via-stream"
  ...
  ;; 16 writable, 20 ownership mask (left=1, middle=2, right=4,
  ;; transferred=8), 32 sink subtask, 36 pending-write state, 40 mode,
  ;; 64 resource-triple slot.
  ...
  (func $layout-markers
    ...
    ;; [producer-seed-order] left then middle then right
    i32.const 0
    drop
  ...
  ;; The ownership mask is independent of the three handle words. Bit 0 owns
  ;; left, bit 1 owns middle, bit 2 owns right, and bit 3 records an atomic
  ;; triple transfer.
  ...
  (func $release-guest-record (param $frame i32)
    ;; A transferred triple must not retain guest-owned bits.
    local.get $frame
    i32.load offset=20
    i32.const 8
    i32.and
  ...
  (func $transfer-record (param $frame i32)
    ;; Only the complete triple may transfer; there is no half-owned state.
    local.get $frame
    i32.load offset=20
    i32.const 7
    i32.and
  ...
  (func (export "[async-lift]produce") (type $async-run-triple)
    (param $mode i32)
    (param $left_seed i32)
    (param $middle_seed i32)
    (param $right_seed i32)
