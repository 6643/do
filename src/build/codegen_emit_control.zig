...
const body_ends_with_plain_return = codegen_control_flow.body_ends_with_plain_return;
const body_can_reach_end = codegen_control_flow.body_can_reach_end;
const stmt_can_reach_end = codegen_control_flow.stmt_can_reach_end;
const if_stmt_can_reach_end = codegen_control_flow.if_stmt_can_reach_end;
const loop_stmt_can_reach_end = codegen_control_flow.loop_stmt_can_reach_end;
const loop_body_can_break_current_loop = codegen_control_flow.loop_body_can_break_current_loop;
const stmt_breaks_current_loop = codegen_control_flow.stmt_breaks_current_loop;
const break_targets_current_loop = codegen_control_flow.break_targets_current_loop;
const token_range_contains_labeled_break = codegen_control_flow.token_range_contains_labeled_break;
const same_loop_control = codegen_control_flow.same_loop_control;
...
const previous_line_start = codegen_control_flow.previous_line_start;
