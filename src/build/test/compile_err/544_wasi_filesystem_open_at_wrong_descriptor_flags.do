open_at_descriptor = @host_async_func("wasi:filesystem/types@0.3.0-rc-2025-09-16", "descriptor.open-at", (Dir, u32, text, u32, text) -> File | OpenError)
...
run(root Dir, path_flags u32, path text, open_flags u32, descriptor_flags text) -> File | OpenError {
