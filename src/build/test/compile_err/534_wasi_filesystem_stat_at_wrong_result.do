stat_at_descriptor = @host_async_func("wasi:filesystem/types@0.3.0-rc-2025-09-16", "descriptor.stat-at", (Dir, u32, text) -> u32 | StatError)
...
run(file Dir, path_flags u32, path text) -> u32 | StatError {
    pending Future<u32 | StatError> = stat_at_descriptor(file, path_flags, path)
