stat_at_descriptor = @host_async_func("wasi:filesystem/types@0.3.0-rc-2025-09-16", "descriptor.stat-at", (Dir, text, text) -> DescriptorStat | StatError)
...
run(file Dir, path_flags text, path text) -> DescriptorStat | StatError {
