open_at_descriptor = @host_async_func("wasi:filesystem/types@0.3.0-rc-2025-09-16", "descriptor.open-at", (Dir, text, text, u32, u32) -> File | OpenError)
...
run(root Dir, path_flags text, path text, open_flags u32, descriptor_flags u32) -> File | OpenError {
