metadata_hash_at = @host_async_func("wasi:filesystem/types@0.3.0-rc-2025-09-16", "descriptor.metadata-hash-at", (Dir, text, text) -> MetadataHash | HashError)
...
run(file Dir, path_flags text, path text) -> MetadataHash | HashError {
