...
DescriptorStat = @wasi_record("filesystem/types/descriptor-stat", { .type i32, link_count u64, size u32, data_access_timestamp option<Datetime>, data_modification_timestamp option<Datetime>, status_change_timestamp option<Datetime> })
