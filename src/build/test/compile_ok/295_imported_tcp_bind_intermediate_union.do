// G6.3 edge: imported wrapper uses intermediate payload-enum local before host bind.
// Regression for collectImportedPayloadEnumDecls (module-local IpSocketAddress).
