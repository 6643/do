...
const pure_lowering_cases = [_]PureLoweringCase{
    ...
    .{
        .name = "WASI filesystem bounded byte stream reader lowering",
        .source = "examples/p3-runtime/wasi-filesystem-read-via-stream.do",
        .build_flag = "--p3-async-component",
        .world = "read-via-stream-probe",
        .wit_snapshot = "examples/p3-runtime/wit/wasi-filesystem-read-via-stream.wit",
        .wit_markers = &.{
        ...
        .forbidden_markers = &.{ "[async-lower][method]descriptor.read-via-stream" },
        .validate_core = true,
    },
    .{
