...
const model = @import("import_model.zig");

pub const ImportRef = model.ImportRef;
pub const ModuleGraph = model.ModuleGraph;
...
const Context = struct {
    ...
    allocator: std.mem.Allocator,
    dep_root: []const u8,
    modules: std.ArrayList(model.ModuleRecord),
    ...
    fn init(
        ...
        return .{
            ...
            .allocator = allocator,
            .dep_root = dep_root,
            .modules = std.ArrayList(model.ModuleRecord).empty,
