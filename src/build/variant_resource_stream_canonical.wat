(module
  ...
  (import "do:variant-resource-stream-canonical/source@0.1.0" "read-via-stream" (func $source-acquire (type $source-acquire)))
  (import "do:variant-resource-stream-canonical/source@0.1.0" "[async-lower][stream-read-0]read-via-stream" (func $stream-read (type $stream-read)))
  (import "do:variant-resource-stream-canonical/source@0.1.0" "[stream-drop-readable-0]read-via-stream" (func $stream-drop (type $drop)))
  (import "do:variant-resource-stream-canonical/source@0.1.0" "[async-lower][future-read-1]read-via-stream" (func $future-read (type $future-read)))
  (import "do:variant-resource-stream-canonical/source@0.1.0" "[future-drop-readable-1]read-via-stream" (func $future-drop (type $drop)))
  (import "do:variant-resource-stream-canonical/source@0.1.0" "[resource-drop]ticket" (func $ticket-drop (type $drop)))
  ...
  (import "[export]do:variant-resource-stream-canonical/probe@0.1.0" "[task-return]run" (func $task-return (type $task-return)))
  ...
  (func (export "[async-lift]do:variant-resource-stream-canonical/probe@0.1.0#run") (type $async-run) (result i32) (local $frame i32)
    call $frame-alloc
    local.tee $frame
    call $context-set
    local.get $frame
  ...
  (func (export "[callback][async-lift]do:variant-resource-stream-canonical/probe@0.1.0#run") (type $async-callback) (param $event i32) (param $index i32) (param $payload i32) (result i32) (local $frame i32)
    call $context-get
    local.set $frame
    local.get $event
    i32.const 1
