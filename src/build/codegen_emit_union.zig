...
pub const wasm_type = codegen_storage_layout.wasm_type;
pub const value_enum_carrier = codegen_storage_layout.value_enum_carrier;
pub const codegen_scalar_type = codegen_storage_layout.codegen_scalar_type;
