...
tmp_dir=$(mktemp -d "${TMPDIR:-/tmp}/do-gc-marshal-record-managed-lower-multi-equivalence.XXXXXX")
...
printf 'manifest-backed multi-managed-field record lower ARC/GC equivalence passed\n'
