...
tmp_dir=$(mktemp -d "${TMPDIR:-/tmp}/do-gc-marshal-record-nested-lift-deeper-equivalence.XXXXXX")
...
printf 'manifest-backed four-level nested scalar record lift ARC/GC equivalence passed\n'
