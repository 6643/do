...
"$wasm_tools_bin" parse "$wat_path" -o "$tmp_dir/four-level-nested-field-path.wasm"
"$wasmtime_bin" compile -W gc=y -o "$tmp_dir/four-level-nested-field-path.compiled" "$wat_path"
