...
tmp_dir=$(mktemp -d "${TMPDIR:-/tmp}/do-gc-marshal-record-managed-lower-equivalence.XXXXXX")
...
printf 'manifest-backed managed-field record lower ARC/GC equivalence passed\n'
