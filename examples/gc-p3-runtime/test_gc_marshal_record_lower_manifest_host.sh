...
probe="$repo_root/src/gc_marshal_record_lower_probe_main.zig"
...
cp "$repo_root/doc/wit/gc_marshal_record_lower_imports.wit" "$mutated_root/doc/wit/gc_marshal_record_lower_imports.wit"
...
printf 'manifest-backed scalar record lower Component host execution passed\n'
