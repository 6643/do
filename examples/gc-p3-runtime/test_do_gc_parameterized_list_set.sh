...
"${WASM_TOOLS_BIN:-wasm-tools}" parse "$wat_path" -o "$tmp_dir/parameterized-list-set.wasm"
"$wasmtime_bin" compile -W gc=y -o "$tmp_dir/parameterized-list-set.compiled" "$wat_path"
