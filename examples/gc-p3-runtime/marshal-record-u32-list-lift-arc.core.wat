;; Linear-memory record/list result path for C18 ARC/GC equivalence.
(module
  (type $canonical_lift (func (param i32)))
  (type $cabi_realloc_type (func (param i32 i32 i32 i32) (result i32)))
  (import "demo:marshal-record-u32-list-lift/api@1.0.0" "read" (func $canonical_call (type $canonical_lift)))
