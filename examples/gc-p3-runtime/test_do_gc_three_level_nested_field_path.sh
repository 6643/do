...
"$toolchain_bin" parse-core "$wat_path" -o "$tmp_dir/three-level-nested-field-path.wasm"
"$toolchain_bin" compile-core-gc "$wat_path" -o "$tmp_dir/three-level-nested-field-path.compiled"
