...
tmp_dir=$(mktemp -d "${TMPDIR:-/tmp}/do-gc-marshal-record-lower-manifest-equivalence.XXXXXX")
...
printf 'manifest-backed GC/flat scalar record lower equivalence passed\n'
