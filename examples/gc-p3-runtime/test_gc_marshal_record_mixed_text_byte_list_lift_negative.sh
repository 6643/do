...
tmp_dir=$(mktemp -d "${TMPDIR:-/tmp}/do-gc-marshal-record-mixed-text-byte-list-lift-negative.XXXXXX")
...
printf 'mixed text/byte-list record lift negative compiler gates passed\n'
