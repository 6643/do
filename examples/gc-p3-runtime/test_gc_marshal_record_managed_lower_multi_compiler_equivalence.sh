...
tmp_dir=$(mktemp -d "${TMPDIR:-/tmp}/do-gc-marshal-record-managed-lower-multi-compiler-equivalence.XXXXXX")
...
printf '%s\n' "$output"
printf 'compiler-wired multi-managed-field record lower ARC/GC equivalence passed\n'
