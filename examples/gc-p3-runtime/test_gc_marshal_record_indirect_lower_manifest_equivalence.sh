...
tmp_dir=$(mktemp -d "${TMPDIR:-/tmp}/do-gc-marshal-record-indirect-lower-manifest-equivalence.XXXXXX")
...
printf 'manifest-backed GC/flat indirect scalar record lower equivalence passed\n'
