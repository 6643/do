...
tmp_dir=$(mktemp -d "${TMPDIR:-/tmp}/do-gc-marshal-record-nested-lower-deeper-equivalence.XXXXXX")
...
printf 'manifest-backed four-level nested scalar record lower ARC/GC equivalence passed\n'
