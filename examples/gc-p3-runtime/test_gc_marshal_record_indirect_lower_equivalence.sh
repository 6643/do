...
"$wasm_tools_bin" parse "$flat_wat" -o "$tmp_dir/flat.core.wasm"
"$wasm_tools_bin" component embed "$wit" "$tmp_dir/flat.core.wasm" --world probe -o "$tmp_dir/flat.embedded.wasm"
"$wasm_tools_bin" component new "$tmp_dir/flat.embedded.wasm" -o "$tmp_dir/flat.component.wasm"
"$wasm_tools_bin" validate "$tmp_dir/gc.component.wasm"
"$wasm_tools_bin" validate "$tmp_dir/flat.component.wasm"
