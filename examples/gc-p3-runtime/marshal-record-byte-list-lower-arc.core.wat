;; Linear-memory byte-list record lower reference for ARC/GC equivalence.
(module
  (type $canonical_lower (func (param i32 i32 i32)))
  (type $cabi_realloc_type (func (param i32 i32 i32 i32) (result i32)))
  (import "demo:marshal-record-byte-list-lower/api@1.0.0" "write" (func $canonical_call (type $canonical_lower)))
