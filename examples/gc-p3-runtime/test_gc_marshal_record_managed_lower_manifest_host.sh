...
probe="$repo_root/src/gc_marshal_record_managed_lower_probe_main.zig"
runner_manifest="$repo_root/examples/p3-runtime/rust-host-runner/Cargo.toml"
tmp_dir=$(mktemp -d "${TMPDIR:-/tmp}/do-gc-marshal-record-managed-lower-host.XXXXXX")
...
record_source_relative='examples/gc-p3-runtime/marshal-record-managed-lower-manifest-source.wit'
...
cp "$repo_root/doc/wit/gc_marshal_record_managed_lower_imports.wit" "$mutated_root/doc/wit/gc_marshal_record_managed_lower_imports.wit"
...
printf 'manifest-backed managed-field record lower Component host execution passed\n'
