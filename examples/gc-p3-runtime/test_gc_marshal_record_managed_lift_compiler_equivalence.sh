...
tmp_dir=$(mktemp -d "${TMPDIR:-/tmp}/do-gc-marshal-record-managed-lift-compiler-equivalence.XXXXXX")
...
printf '%s\n' "$output"
printf 'compiler-wired managed-field record lift ARC/GC equivalence passed\n'
