...
tmp_dir=$(mktemp -d "${TMPDIR:-/tmp}/do-gc-marshal-record-mixed-text-u32-list-lift-equivalence.XXXXXX")
...
printf '%s\n' "$output"
printf 'manifest-backed mixed text/u32-list record lift ARC/GC equivalence passed\n'
