;; Linear-memory ARC oracle for the exact two-u32-list record lower route.
(module
  (type $canonical_lower (func (param i32 i32 i32 i32 i32)))
  (type $cabi_realloc_type (func (param i32 i32 i32 i32) (result i32)))
  (import "demo:marshal-record-two-u32-lists-lower/api@1.0.0" "write" (func $canonical_call (type $canonical_lower)))
