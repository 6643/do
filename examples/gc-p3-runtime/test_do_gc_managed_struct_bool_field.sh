...
"$toolchain_bin" parse-core "$wat_path" -o "$tmp_dir/managed-struct-bool-field.wasm"
"$toolchain_bin" compile-core-gc "$wat_path" -o "$tmp_dir/managed-struct-bool-field.compiled"
