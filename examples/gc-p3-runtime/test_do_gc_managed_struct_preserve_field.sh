...
"$toolchain_bin" parse-core "$wat_path" -o "$tmp_dir/managed-struct-preserve-field.wasm"
"$toolchain_bin" compile-core-gc "$wat_path" -o "$tmp_dir/managed-struct-preserve-field.compiled"
