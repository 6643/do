...
core_wasm="$tmp_dir/stream-writer-producer-helper-owned.wasm"
embedded_path="$tmp_dir/stream-writer-producer-helper-owned.embedded.wasm"
component_path="$tmp_dir/stream-writer-producer-helper-owned.component.wasm"
...
printf 'async-helper-owned producer lease pending/ready/error runtime passed\n'
