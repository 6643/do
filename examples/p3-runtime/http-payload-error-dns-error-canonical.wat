(module
  ...
  ;; Pinned full HTTP error-code task-return shape. DNS-error's record
  ;; payload uses option<string>, option<u16> and the joined flat slots below.
  ...
  (data (i32.const 512) "EAI")
  (func (export "[async-lift]wasi:http/probe@0.3.0-rc-2025-09-16#run")
    (type $async-probe)
    ;; result = Err, DNS-error tag 1, rcode Some("EAI"), info-code Some(7).
    i32.const 1
    i32.const 1
    i32.const 1
    i64.const 512
