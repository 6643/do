(module
  ...
  (import "wasi:filesystem/types@0.3.0-rc-2025-09-16"
    "[async-lower][method]descriptor.stat" (func $stat (type $method)))
  ;; [descriptor-drop]
  (import "wasi:filesystem/types@0.3.0-rc-2025-09-16"
  ...
  ;; [stat-ready] deterministic regular-file payload for a completed call.
  (func $write-ready (param $frame i32)
    local.get $frame i32.const 8 i32.add i32.const 0 i32.store8
    local.get $frame i32.const 16 i32.add i32.const 6 i32.store8
    local.get $frame i32.const 24 i32.add i64.const 1 i64.store
    local.get $frame i32.const 32 i32.add i64.const 4096 i64.store
    local.get $frame i32.const 40 i32.add i32.const 1 i32.store8
    local.get $frame i32.const 48 i32.add i64.const 100 i64.store
    local.get $frame i32.const 56 i32.add i32.const 1 i32.store
    local.get $frame i32.const 64 i32.add i32.const 1 i32.store8
    local.get $frame i32.const 72 i32.add i64.const 101 i64.store
    local.get $frame i32.const 80 i32.add i32.const 2 i32.store
    local.get $frame i32.const 88 i32.add i32.const 1 i32.store8
    local.get $frame i32.const 96 i32.add i64.const 102 i64.store
    local.get $frame i32.const 104 i32.add i32.const 3 i32.store
  )

  ;; [stat-error] error-code occupies the first payload slot and all record
  ...
  (func $write-error (param $frame i32) (param $code i32)
    ...
    local.get $frame i32.const 16 i32.add local.get $code i32.store8
    local.get $frame i32.const 24 i32.add i64.const 0 i64.store
    local.get $frame i32.const 32 i32.add i64.const 0 i64.store
    local.get $frame i32.const 40 i32.add i32.const 0 i32.store8
    local.get $frame i32.const 48 i32.add i64.const 0 i64.store
    local.get $frame i32.const 56 i32.add i32.const 0 i32.store
    local.get $frame i32.const 64 i32.add i32.const 0 i32.store8
    local.get $frame i32.const 72 i32.add i64.const 0 i64.store
    local.get $frame i32.const 80 i32.add i32.const 0 i32.store
    local.get $frame i32.const 88 i32.add i32.const 0 i32.store8
    local.get $frame i32.const 96 i32.add i64.const 0 i64.store
    local.get $frame i32.const 104 i32.add i32.const 0 i32.store
  )

  ;; [stat-pending]
  (func $wait-on-stat (param $frame i32) (result i32)
    local.get $frame i32.const 112 i32.add i32.load
  ...
  (func $finish (param $frame i32) (result i32)
    ...
    local.get $frame i32.const 116 i32.add i32.load
    i32.eqz
    if
    else
      local.get $frame i32.const 116 i32.add i32.load
    ...
    local.get $frame i32.const 16 i32.add i32.load8_u local.set $dtype
    local.get $frame i32.const 24 i32.add i64.load local.set $link
    local.get $frame i32.const 32 i32.add i64.load local.set $size
    local.get $frame i32.const 40 i32.add i32.load8_u local.set $ap
    local.get $frame i32.const 48 i32.add i64.load local.set $as
    local.get $frame i32.const 56 i32.add i32.load local.set $an
    local.get $frame i32.const 64 i32.add i32.load8_u local.set $mp
    local.get $frame i32.const 72 i32.add i64.load local.set $ms
    local.get $frame i32.const 80 i32.add i32.load local.set $mn
    local.get $frame i32.const 88 i32.add i32.load8_u local.set $cp
    local.get $frame i32.const 96 i32.add i64.load local.set $cs
    local.get $frame i32.const 104 i32.add i32.load local.set $cn
  ...
  (func $start-stat (param $frame i32) (result i32)
    ...
    call $stat
    local.set $status
    local.get $frame i32.const 112 i32.add local.get $status i32.store
    local.get $status i32.const 2 i32.eq
    if (result i32)
      local.get $frame call $write-ready
      local.get $frame call $finish
    else
      local.get $frame call $wait-on-stat
    end
  )
  ...
  (func $run (type $async-run)
    ...
    local.get $frame i32.const 8 i32.add i32.const 0 i32.store8
    local.get $frame i32.const 16 i32.add i32.const 0 i32.store8
    local.get $frame i32.const 112 i32.add i32.const 0 i32.store
    local.get $frame i32.const 116 i32.add i32.const 0 i32.store
    local.get $frame call $start-stat
  )
  ...
  (func $cancel (type $async-cancel) (result i32)
    ...
    i32.const 112 i32.add i32.load
    i32.const 4 i32.shr_u
    local.tee $handle
    call $subtask-cancel
    local.set $status
  ...
  (func $callback (type $async-callback)
    ...
    i32.eq
    if (result i32)
      local.get $frame i32.const 116 i32.add local.get 1 i32.store
      local.get 2
      i32.const 2
      i32.eq
      if (result i32)
