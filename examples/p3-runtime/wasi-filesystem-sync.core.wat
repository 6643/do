(module
  ...
  ;; [sync-call] descriptor handle=i32, completion context=i32,
  ;; result status=i32.
  ...
  ;; [sync-pending] retain the waitable and descriptor until the callback.
  ...
  ;; [sync-ready] status=2 means the Result is already complete. The private
  ...
  ;; [sync-error] completion event=1 with payload=error-code stores the error
