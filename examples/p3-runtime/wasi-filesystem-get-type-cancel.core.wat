(module
  ...
  ;; Test-only control endpoint: cancel the host get-type subtask from a
  ;; separate guest task, then let the run callback perform normal cleanup.
