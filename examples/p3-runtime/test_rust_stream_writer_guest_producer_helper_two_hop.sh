...
tmp_dir=$(mktemp -d "${TMPDIR:-/tmp}/do-stream-writer-producer-helper-two-hop-runtime.XXXXXX")
...
printf 'two-hop async-helper producer lease pending/ready/error runtime passed\n'
