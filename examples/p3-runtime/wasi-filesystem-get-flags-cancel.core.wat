(module
  ;; Cancellation variant: the run task is retained in a global so a separate
  ;; exported cancel task can cancel the live get-flags subtask.
  ...
  ;; [get-flags-cancel] cancel export cancels the live subtask.
