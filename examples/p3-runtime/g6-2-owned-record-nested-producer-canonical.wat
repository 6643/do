(module
  ...
  (import "do:g6-2-owned-record-nested-producer/types@0.1.0" "[resource-drop]ticket"
    (func $ticket-drop (type $resource-drop)))
  (import "do:g6-2-owned-record-nested-producer/source@0.1.0" "make-ticket"
    (func $make-ticket (type $make-ticket)))
  (import "do:g6-2-owned-record-nested-producer/sink@0.1.0" "[async-lower]consume-via-stream"
    (func $sink-call (type $async-lower)))
  (import "do:g6-2-owned-record-nested-producer/sink@0.1.0" "[stream-new-0]consume-via-stream"
    (func $stream-new (type $stream-new)))
  (import "do:g6-2-owned-record-nested-producer/sink@0.1.0" "[stream-cancel-read-0]consume-via-stream"
    (func $stream-cancel-read (type $stream-cancel)))
  (import "do:g6-2-owned-record-nested-producer/sink@0.1.0" "[stream-cancel-write-0]consume-via-stream"
    (func $stream-cancel-write (type $stream-cancel)))
  (import "do:g6-2-owned-record-nested-producer/sink@0.1.0" "[stream-drop-readable-0]consume-via-stream"
    (func $stream-drop-readable (type $stream-drop)))
  (import "do:g6-2-owned-record-nested-producer/sink@0.1.0" "[stream-drop-writable-0]consume-via-stream"
    (func $stream-drop-writable (type $stream-drop)))
  (import "do:g6-2-owned-record-nested-producer/sink@0.1.0" "[async-lower][stream-read-0]consume-via-stream"
    (func $stream-read (type $stream-io)))
  (import "do:g6-2-owned-record-nested-producer/sink@0.1.0" "[async-lower][stream-write-0]consume-via-stream"
  ...
  ;; 16 writable, 20 nested ownership mask (inner.ticket=1,
  ;; transferred=2), 32 sink subtask, 36 pending-write state, 40 mode,
  ;; 64 flattened inner.ticket record slot.
  ...
  ;; Bit 0 owns inner.ticket. Bit 1 records transfer to the stream/host.
  ...
  (func $make-record (param $frame i32) (param $mode i32) (result i32)
    ...
    call $make-ticket
    local.set $handle
    ;; Handle zero is valid; bit 0, not the handle value, tracks ownership.
    local.get $frame
    i32.const 64
    i32.add
    local.get $handle
