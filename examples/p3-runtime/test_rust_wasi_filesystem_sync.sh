...
"$toolchain_bin" embed-component "$wit" "$core_wasm" sync-probe \
  --features component-async -o "$embedded"
"$toolchain_bin" new-component "$embedded" -o "$component"
"$toolchain_bin" validate-component "$component" --features component-async

"$toolchain_bin" parse-core "$cancel_core_wat" -o "$cancel_core_wasm"
"$toolchain_bin" embed-component "$cancel_wit" "$cancel_core_wasm" sync-cancel-probe \
...
"$toolchain_bin" embed-component "$generated_wit" "$generated_core_wasm" sync-probe \
