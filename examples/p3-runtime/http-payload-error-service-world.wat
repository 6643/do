(module
  ...
  ;; Direct handler-world candidate. It deliberately does not call client.send:
  ;; this isolates handler task-return lifting from the request/frame path.
  ...
  (func (export "[async-lift]wasi:http/handler@0.3.0-rc-2025-09-16#handle")
    (type $async-handler)
    ;; Err, error tag 38, option discriminant 1, string pointer 512, length 1.
    i32.const 1
    i32.const 38
    i32.const 1
    i64.const 512
