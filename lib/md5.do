...
.block(a u32, b u32, c u32, d u32, chunk List<u8>, base usize) -> u32, u32, u32, u32 {
    ...
    loop {
        ...
        next u32 = step(aa, bb, mix, @get(words, index), @get(md5_k, i), @get(md5_s, i))
