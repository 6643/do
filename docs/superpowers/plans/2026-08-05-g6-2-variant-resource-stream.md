...
- [x] **Step 1: Write the source fixture using ordinary union arms.**
...
- [x] **Step 2: Add the failing lowering script.**
...
- [x] **Step 1: Add the descriptor record.**
...
- [x] **Step 2: Add typed manifest structs and validation.**
...
- [x] **Step 3: Add unit tests for positive and drifted descriptors.**
...
- [x] **Step 1: Add the target enum and dispatcher import.**
...
- [x] **Step 2: Add exact signature matching.**
...
- [x] **Step 3: Add target selection tests.**
...
- [x] **Step 1: Define the emitter API.**
...
- [x] **Step 2: Emit only the measured branches and cleanup.**
...
- [x] **Step 3: Add emitter unit tests.**
...
- [x] **Step 1: Compile and inspect markers.**
...
- [x] **Step 2: Assemble and validate the generated Component.**
...
- [x] **Step 4: Run full regression and document the bounded closeout.**
