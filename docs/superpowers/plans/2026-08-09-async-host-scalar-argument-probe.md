...
- Keep the exact source shape from \`docs/superpowers/specs/2026-08-09-async-host-scalar-argument-probe-design.md\): \`work(u32) -> nil\`, \`helper(value u32)\`, and \`@async(helper(7))\` followed by one \`@await\`.
...
**Files:**
- Verify: \`docs/superpowers/specs/2026-08-09-async-host-scalar-argument-probe-design.md\`
