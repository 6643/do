...
**Files:**
- Create: `docs/superpowers/specs/2026-08-09-async-host-scalar-argument-promotion-design.md`
...
- [ ] **Step 4: Commit the design-only change.**
  ...
  ```bash
  git add docs/superpowers/specs/2026-08-09-async-host-scalar-argument-promotion-design.md
