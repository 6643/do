...
**Files:**
- Create: `docs/superpowers/specs/2026-08-09-borrow-capability-refresh-design.md`
...
`docs/superpowers/specs/2026-08-09-borrow-capability-refresh-design.md` must
...
```bash
git add docs/superpowers/specs/2026-08-09-borrow-capability-refresh-design.md \
...
**Files:**
- Create: `docs/superpowers/specs/2026-08-09-g6-2-scalar-list-producer-design.md`
...
```bash
git add docs/superpowers/specs/2026-08-09-g6-2-scalar-list-producer-design.md \
...
**Files:**
- Create: `docs/superpowers/specs/2026-08-09-general-async-call-promotion-design.md`
- Verify: `docs/superpowers/specs/2026-08-07-general-async-call-lowering-design.md`
...
```bash
git add docs/superpowers/specs/2026-08-09-general-async-call-promotion-design.md
...
**Files:**
- Create: `docs/superpowers/specs/2026-08-09-d2-general-filesystem-async-boundary-design.md`
...
```bash
git add docs/superpowers/specs/2026-08-09-d2-general-filesystem-async-boundary-design.md \
...
```bash
git add docs/superpowers/plans/2026-08-09-next-phase-g6-2-async-boundaries.md \
