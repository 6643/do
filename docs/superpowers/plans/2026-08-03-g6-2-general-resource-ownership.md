...
- Keep `wasm-tools 1.254.0` and Wasmtime `47.0.2` pinned; record toolchain rejection as a boundary, not as a compiler workaround.
...
- [ ] **Step 1: Run the default regression.**
...
Expected: `pass=1068 fail=0 skip=3`.

- [ ] **Step 2: Run the WASM regression with workspace temporary storage.**
...
Expected: `pass=1070 fail=0 skip=3` and `wasm run summary: pass=6 fail=0`.

- [ ] **Step 3: Run ReleaseSmall smoke with workspace caches.**
...
- [ ] **Step 4: Re-run the focused StreamMirror and artifact checks.**

```bash
mkdir -p .tmp/do-tmp/focused-tmp
TMPDIR="$PWD/.tmp/do-tmp/focused-tmp" bash examples/p3-runtime/test_do_stream_mirror_lowering.sh
TMPDIR="$PWD/.tmp/do-tmp/focused-tmp" bash examples/p3-runtime/test_rust_stream_mirror.sh
...
- [ ] **Step 1: Record only fresh counts and commands.**
...
- [ ] **Step 2: Keep cancellation language aligned.**
...
- [ ] **Step 1: Inventory the current verified shapes.**
...
- [ ] **Step 2: Probe the remaining shapes against the pinned toolchain.**
...
- [ ] **Step 3: Define the first implementation candidate from evidence.**
...
- [ ] **Step 4: Review the matrix for scope creep.**
...
- [ ] **Step 1: Define resource/lease states.**
...
- [ ] **Step 2: Define legal transitions and rejection points.**
...
- [ ] **Step 3: Define nested cleanup ordering.**
...
- [ ] **Step 4: Define cancellation terminal behavior.**
...
- [ ] **Step 5: Add proof obligations for a future implementation.**
...
- [ ] **Step 1: Write the two compile-mode rejection fixtures.**
...
- [ ] **Step 2: Write the sema shared-lease fixture and pinned WIT gate.**
...
- [ ] **Step 3: Run the focused boundary gates.**
...
- [ ] **Step 4: Run the complete default regression.**
...
- [ ] **Step 1: Prefer the smallest shape that exercises a new invariant.**
...
- [ ] **Step 2: Reject candidates that require a new product decision.**
...
- [ ] **Step 3: Define the stopping gate.**
