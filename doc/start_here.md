...
- 如果回到全局 roadmap, 先读 `doc/roadmap_status.md` 的阶段 C；B1、B2、B3 和 B4 不要重开, C1.1/C1.2/C1.3/C1.4/C1.5/C1.6、C2.1、C2.2、C2.3、C2.4、C2.5、C3.1、C3.2、C3.3、C3.4、C4.1、C4.2、C4.3、C4.4、C4.5 和 C5.1 已完成, 下一步从 C5.2 为纯函数库补 `do test` fixture 开始。
