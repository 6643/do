...
- 当前主线已经推进到 `doc/roadmap_status.md` 的 `07. 生态工具`，其中 `07.1 do run` 第一版桥接和 `07.2 do fmt` 第一版已完成。
...
- 如果回到全局 roadmap, 先读 `doc/roadmap_status.md` 的第 07 节；`07.1` 和 `07.2` 不要重开, 下一步从 `07.3` 开始明确 LSP 最小能力集和诊断来源。
