...
- 如果回到全局 roadmap, 先读 `doc/roadmap_status.md` 的阶段 C；B1、B2、B3 和 B4 不要重开, C1.1/C1.2 已完成, 下一步从 C1.3 固定 `from_json` 支持矩阵和错误边界开始。
...
- 新的总规划入口是 [doc/master_plan.md](/home/_/._/do/doc/master_plan.md); 默认下一步按其中“阶段 C: 标准库与核心库收口”推进。阶段 B 已完成, C1.1/C1.2 已完成, 下一步优先 C1.3 from_json 支持矩阵。
