...
`descriptor.get-type`, `descriptor.sync`, `descriptor.get-flags`, and
`descriptor.sync-data` remain four independently verified private descriptors.
Fresh ABI and
