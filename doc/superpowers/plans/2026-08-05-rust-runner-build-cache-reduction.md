...
| `doc/superpowers/specs/2026-08-05-rust-runner-build-cache-design.md` | Records exact before/after measurements and verification result. |
| `doc/superpowers/plans/2026-08-05-rust-runner-build-cache-reduction.md` | Tracks this bounded cleanup and validation sequence. |
...
**Files:**
- Modify: `doc/superpowers/specs/2026-08-05-rust-runner-build-cache-design.md`
- Modify: `doc/superpowers/plans/2026-08-05-rust-runner-build-cache-reduction.md`
...
- [x] **Step 2: Check formatting and the targeted diff.**
  ...
  ```bash
  rg -n '[[:blank:]]+$' examples/p3-runtime/rust-host-runner/Cargo.toml doc/superpowers/specs/2026-08-05-rust-runner-build-cache-design.md doc/superpowers/plans/2026-08-05-rust-runner-build-cache-reduction.md
  git diff --check
  git status --short -- examples/p3-runtime/rust-host-runner/Cargo.toml doc/superpowers/specs/2026-08-05-rust-runner-build-cache-design.md doc/superpowers/plans/2026-08-05-rust-runner-build-cache-reduction.md
  ```
