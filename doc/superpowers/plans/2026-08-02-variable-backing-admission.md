...
> **Superseded by GC-first (2026-08-11):** The active ARC runtime wording below
> records the implementation state when this plan ran. `doc/memory.md` and
> `doc/design/2026-08-11-gc-first-memory-decision.md` now select Wasm GC.
> Source value semantics and explicit Component/WIT resource ownership are
> unchanged; future backend integration targets GC.
...
- Modify: `doc/superpowers/plans/2026-08-02-variable-backing-admission.md`
