...
The checked-in evidence in `doc/superpowers/specs/2026-08-09-g6-2-scalar-list-producer-design.md` is the ABI source of truth. The compiler promotion is complete only when all of these are true:
...
**Files:**
- Verify: `doc/superpowers/specs/2026-08-09-g6-2-scalar-list-producer-design.md`
