...
- Create `doc/superpowers/specs/2026-08-08-g6-2-batched-list-resource-producer-design.md` for the approved ABI, ownership state machine, and stop conditions.
...
**Files:**
- Create: `doc/superpowers/specs/2026-08-08-g6-2-batched-list-resource-producer-design.md`
...
- [x] **Step 4: Commit the design/probe input only after reviewing the boundary.**
  ...
  ```bash
  git add doc/superpowers/specs/2026-08-08-g6-2-batched-list-resource-producer-design.md \
