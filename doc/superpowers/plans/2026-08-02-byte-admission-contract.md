...
> **Superseded by GC-first (2026-08-11):** This dated plan's references to an
> active ARC backend and Runtime/ARC gates describe its original implementation
> state. `doc/memory.md` and `doc/design/2026-08-11-gc-first-memory-decision.md`
> now select Wasm GC. Source value semantics and explicit Component/WIT resource
> ownership are unchanged; remaining backend integration targets GC.
