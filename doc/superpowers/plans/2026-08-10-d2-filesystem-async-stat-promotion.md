...
- Create doc/superpowers/specs/2026-08-10-d2-filesystem-async-stat-design.md for source, ABI, layout, ownership, cancellation, and stop conditions.
...
Create doc/superpowers/specs/2026-08-10-d2-filesystem-async-stat-design.md with the pinned versions/hash, exact WIT signature and record fields, positive runtime modes, ownership/presence matrix, and ABI/runtime stop conditions. Do not state that the method is supported yet.

### Task 2: Probe the pinned WIT and capability matrix

**Files:**
- Modify: doc/superpowers/specs/2026-08-10-d2-filesystem-async-stat-design.md
