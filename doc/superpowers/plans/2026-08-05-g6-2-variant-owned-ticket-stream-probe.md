...
| `doc/superpowers/specs/2026-08-05-g6-2-variant-owned-ticket-stream-design.md` | Records measured ABI facts and changes status only after the green gate. |
...
- Modify: `doc/superpowers/specs/2026-08-05-g6-2-variant-owned-ticket-stream-design.md`
