...
**Files:**
- Modify: `doc/superpowers/specs/2026-07-29-result-core-design.md`
- Modify: `doc/superpowers/plans/2026-08-05-result-union-source-migration.md`
...
```bash
rg -n 'ordinary|public|Result<|T \| E|own<T>|borrow<T>' doc doc/superpowers/specs/2026-07-29-result-core-design.md doc/superpowers/plans/2026-08-05-result-union-source-migration.md
git diff --check
```
