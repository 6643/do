...
**Files:**
- Modify: `doc/superpowers/specs/2026-08-05-a-g6-2-d2-next-phase-design.md`
...
- [x] **Step 4: Validate the documentation-only change.**
  ...
  rg -n "not yet.*registry|not.*entered.*compiler|socket create/bind/drop|D2" \
    doc/superpowers/specs/2026-08-05-a-g6-2-d2-next-phase-design.md \
...
**Files:**
- Create: `doc/superpowers/specs/2026-08-05-g6-2-next-shape-design.md`
