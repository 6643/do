...
- Delete: `doc/superpowers/plans/2026-07-28-wasmtime-p3-go-channel-runtime.md`

**Consumes:** The approved design at
`doc/superpowers/specs/2026-07-29-async-future-stream-design.md`.
...
rg -n '旧 async|Channel<T>|do worker|send.*recv|LegacyAsyncSyntax' \
  doc src/build doc/superpowers --glob '*.md' --glob '*.zig' --glob '*.do' --glob '*.expect'
```
