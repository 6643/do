...
- Create: `doc/superpowers/specs/2026-08-08-d2-filesystem-async-get-type-design.md`
...
rg -n 'generic|own<T>|borrow<T>|ref<T>|external HTTP|independent guest' \
  doc/superpowers/plans/2026-08-08-d2-filesystem-async-get-type.md
git diff --check
```
