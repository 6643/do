...
- [ ] I2.1 固定 `Tuple` 规格、arity、位置构造器和数字索引读取规则。
- [ ] I2.2 更新 grammar / parser。
- [ ] I2.3 更新 sema 内建类型、构造器和字段访问规则。
- [ ] I2.4 更新 codegen layout / access / return / param / storage lowering。
- [ ] I2.5 补 Tuple 正反例回归。
